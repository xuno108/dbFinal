						...
						<div class="inner">
							...
							<?php
								$con = new mysqli("localhost", "root", "Tl51189@", "moviedb");
									...
									$result = $con->query ("SELECT * FROM movie WHERE mCat Like '%幻%' ");
											...
											<div class=\"content\">
												<div class=\"inner\">
													...
													echo "<ul class=\"actions\">";
														...
														{
															?>
															<li><a class="button" type="submit" formmethod="get" onclick="location.href='get.php?mId=<?=$row['mId']?>'">加入片單</a></li>
															<?php
